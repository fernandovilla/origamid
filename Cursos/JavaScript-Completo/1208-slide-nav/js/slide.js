...
export class SlideNav extends Slide {
  ...
  eventControl(item, index) {
    ...
    this.wrapper.addEventListener("changeSlideEvent", this.activeControlItem);
  }
  ...
  addControl(customControl) {
    ...
    //  transforma o HTMLNodeList em um array de filhos...
    this.controlArray = [...this.control.children];

    this.activeControlItem();

    //  declaração do callback é igual aos argumentos do forEach(), não precisar passar item e index...
